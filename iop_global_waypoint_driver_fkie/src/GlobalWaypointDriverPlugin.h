...
#ifndef GLOBALWAYPOINTDRIVERPLUGIN_H
#define GLOBALWAYPOINTDRIVERPLUGIN_H

#include "urn_jaus_jss_mobility_GlobalWaypointDriver/GlobalWaypointDriverService.h"
...
class DllExport GlobalWaypointDriverPlugin : public PluginInterface
{
public:
	GlobalWaypointDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_GlobalWaypointDriver::GlobalWaypointDriverService *p_my_service;
