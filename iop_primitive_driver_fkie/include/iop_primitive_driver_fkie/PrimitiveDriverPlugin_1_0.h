...
#ifndef PRIMITIVEDRIVERPLUGIN_1_0_H
#define PRIMITIVEDRIVERPLUGIN_1_0_H
...
class DllExport PrimitiveDriverPlugin_1_0 : public PluginInterface
{
public:
	PrimitiveDriverPlugin_1_0();
	...
	virtual ~PrimitiveDriverPlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:mobility:PrimitiveDriver"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 0; }

protected:
	urn_jaus_jss_mobility_PrimitiveDriver_1_0::PrimitiveDriverService *p_my_service;
	urn_jaus_jss_core_Management_1_0::ManagementService *p_base_service;
