...
#ifndef PRIMITIVEDRIVERPLUGIN_H
#define PRIMITIVEDRIVERPLUGIN_H

#include "urn_jaus_jss_mobility_PrimitiveDriver/PrimitiveDriverService.h"
...
class DllExport PrimitiveDriverPlugin : public PluginInterface
{
public:
	PrimitiveDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_PrimitiveDriver::PrimitiveDriverService *p_my_service;
