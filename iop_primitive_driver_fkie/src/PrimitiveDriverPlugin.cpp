...
#include "PrimitiveDriverPlugin.h"
...
PrimitiveDriverPlugin::PrimitiveDriverPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* PrimitiveDriverPlugin::get_service()
{
	return p_my_service;
}

void PrimitiveDriverPlugin::create_service(JTS::JausRouter* jaus_router)
{
...
PLUGINLIB_EXPORT_CLASS(iop::PrimitiveDriverPlugin, iop::PluginInterface)
