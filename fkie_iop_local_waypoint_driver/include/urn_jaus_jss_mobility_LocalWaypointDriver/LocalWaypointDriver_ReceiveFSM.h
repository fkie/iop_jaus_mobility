...
public:
    ...
    virtual void setTravelSpeedExtAction(SetTravelSpeedExt msg, Receive::Body::ReceiveRec transportData);
    virtual void setWaypointAction(SetLocalWaypoint msg, Receive::Body::ReceiveRec transportData);
    virtual void setWaypointExtAction(SetLocalWaypointExt msg, Receive::Body::ReceiveRec transportData);
