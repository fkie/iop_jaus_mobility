...
void LocalWaypointDriver_ReceiveFSM::setupNotifications()
{
    ...
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_NotControlled", ieHandler, "InternalStateChange_To_LocalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    ...
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_Controlled_Failure", ieHandler, "InternalStateChange_To_LocalWaypointDriver_ReceiveFSM_Receiving_Ready_Controlled_Failure", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_Controlled", ieHandler, "InternalStateChange_To_LocalWaypointDriver_ReceiveFSM_Receiving_Ready_Controlled_Available_Standby", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready", ieHandler, "InternalStateChange_To_LocalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving", ieHandler, "InternalStateChange_To_LocalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available_Standby", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Init", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Failure", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Shutdown", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Emergency", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Available_Standby", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available_Ready", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable_Emergency", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Failure", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled_Failure", "LocalWaypointDriver_ReceiveFSM");
...
void LocalWaypointDriver_ReceiveFSM::sendReportLocalWaypointExtAction(QueryLocalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
...
void LocalWaypointDriver_ReceiveFSM::sendReportTravelSpeedExtAction(QueryTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
...
void LocalWaypointDriver_ReceiveFSM::setTravelSpeedExtAction(SetTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
...
void LocalWaypointDriver_ReceiveFSM::setWaypointExtAction(SetLocalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
...
bool LocalWaypointDriver_ReceiveFSM::waypointExists(QueryLocalWaypointExt msg)
{
    /// Insert User Code HERE
...
bool LocalWaypointDriver_ReceiveFSM::waypointExists(SetTravelSpeedExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists for SetTravelSpeedExt not implemented");
    return false;
}
