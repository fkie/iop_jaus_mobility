...
#ifndef LOCALWAYPOINTDRIVERPLUGIN_H
#define LOCALWAYPOINTDRIVERPLUGIN_H

#include "urn_jaus_jss_mobility_LocalWaypointDriver/LocalWaypointDriverService.h"
...
class DllExport LocalWaypointDriverPlugin : public PluginInterface
{
public:
	LocalWaypointDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_LocalWaypointDriver::LocalWaypointDriverService *p_my_service;
