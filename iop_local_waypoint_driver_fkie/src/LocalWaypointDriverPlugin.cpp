...
#include "LocalWaypointDriverPlugin.h"
...
LocalWaypointDriverPlugin::LocalWaypointDriverPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* LocalWaypointDriverPlugin::get_service()
{
	return p_my_service;
}

void LocalWaypointDriverPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new LocalWaypointDriverService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::LocalWaypointDriverPlugin, iop::PluginInterface)
