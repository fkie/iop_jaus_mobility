...
public:
    ...
    /// Action Methods
    virtual void sendReportLocalPoseAction(QueryLocalPose msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportLocalPoseExtAction(QueryLocalPoseExt msg, Receive::Body::ReceiveRec transportData);
    virtual void updateLocalPoseAction(SetLocalPose msg);
    virtual void updateLocalPoseExtAction(SetLocalPoseExt msg);
...
protected:
	...
	ReportLocalPoseExt p_report_local_pose_ext;
