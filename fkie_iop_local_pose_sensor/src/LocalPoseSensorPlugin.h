...
#ifndef LOCALPOSESENSORPLUGIN_H
#define LOCALPOSESENSORPLUGIN_H

#include "urn_jaus_jss_mobility_LocalPoseSensor/LocalPoseSensorService.h"
...
class DllExport LocalPoseSensorPlugin : public PluginInterface
{
public:
	LocalPoseSensorPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_LocalPoseSensor::LocalPoseSensorService *p_my_service;
