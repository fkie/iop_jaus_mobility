...
{
    pAccessControl_ReceiveFSM->registerNotification("Receiving_Ready_NotControlled", ieHandler, "InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_NotControlled_Available", "AccessControl_ReceiveFSM");
    pAccessControl_ReceiveFSM->registerNotification("Receiving_Ready_Controlled", ieHandler, "InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_Controlled_Available", "AccessControl_ReceiveFSM");
    pAccessControl_ReceiveFSM->registerNotification("Receiving_Ready", ieHandler, "InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_NotControlled_Available", "AccessControl_ReceiveFSM");
    pAccessControl_ReceiveFSM->registerNotification("Receiving", ieHandler, "InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_NotControlled_Available", "AccessControl_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_NotControlled", "LocalPoseSensor_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_NotControlled", "LocalPoseSensor_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Available", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_Controlled", "LocalPoseSensor_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_Controlled", "LocalPoseSensor_ReceiveFSM");
...
void LocalPoseSensor_ReceiveFSM::sendReportLocalPoseAction(QueryLocalPose msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    JausAddress sender = transportData.getAddress();
    RCLCPP_DEBUG(logger, "request ReportLocalPose from %s", sender.str().c_str());
    this->sendJausMessage(p_report_local_pose, sender);
}

void LocalPoseSensor_ReceiveFSM::sendReportLocalPoseExtAction(QueryLocalPoseExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportLocalPoseExtAction not implemented");
}
...
void LocalPoseSensor_ReceiveFSM::updateLocalPoseExtAction(SetLocalPoseExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "updateLocalPoseExtAction not implemented");
}
