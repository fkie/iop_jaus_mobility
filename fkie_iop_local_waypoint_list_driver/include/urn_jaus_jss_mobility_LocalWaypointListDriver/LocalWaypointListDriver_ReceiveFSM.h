...
public:
    ...
    virtual void executeWaypointListAction(ExecuteListExt msg, Receive::Body::ReceiveRec transportData);
    virtual void modifyTravelSpeedAction(ExecuteList msg, Receive::Body::ReceiveRec transportData);
    virtual void modifyTravelSpeedAction(ExecuteListExt msg, Receive::Body::ReceiveRec transportData);
    virtual void resetTravelSpeedAction();
    virtual void sendConfirmElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData);
    virtual void sendRejectElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData);
    ...
    virtual void sendReportLocalWaypointExtAction(QueryLocalWaypointExt msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportTravelSpeedAction(QueryTravelSpeed msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportTravelSpeedExtAction(QueryTravelSpeedExt msg, Receive::Body::ReceiveRec transportData);
    ...
    virtual bool elementExists(ExecuteListExt msg);
    virtual bool elementSpecified(ExecuteList msg);
    virtual bool elementSpecified(ExecuteListExt msg);
    ...
    virtual bool waypointExists(QueryLocalWaypointExt msg);
