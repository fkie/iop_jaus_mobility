...
void LocalWaypointListDriver_ReceiveFSM::setupNotifications()
{
    ...
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready_NotControlled", ieHandler, "InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    ...
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready_Controlled", ieHandler, "InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_Available_Standby", "ListManager_ReceiveFSM");
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready", ieHandler, "InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    pListManager_ReceiveFSM->registerNotification("Receiving", ieHandler, "InternalStateChange_To_LocalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available_Standby", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Init", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Failure", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Shutdown", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Emergency", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "LocalWaypointListDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Available_Standby", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available_Ready", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable_Emergency", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "LocalWaypointListDriver_ReceiveFSM");
...
void LocalWaypointListDriver_ReceiveFSM::setupIopConfiguration()
{
    ...
    pListManager_ReceiveFSM->list_manager().register_supported_element(ReportLocalWaypoint::ID, this);
...
void LocalWaypointListDriver_ReceiveFSM::executeWaypointListAction(ExecuteListExt msg, Receive::Body::ReceiveRec transportData)
{
    RCLCPP_WARN(logger, "executeWaypointListAction for ExecuteListExt not implemented");
}

void LocalWaypointListDriver_ReceiveFSM::modifyTravelSpeedAction(ExecuteList msg, Receive::Body::ReceiveRec transportData)
{
    double speed = msg.getBody()->getExecuteListRec()->getSpeed();
...
void LocalWaypointListDriver_ReceiveFSM::modifyTravelSpeedAction(ExecuteListExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "modifyTravelSpeedAction for ExecuteListExt not implemented");
}
...
void LocalWaypointListDriver_ReceiveFSM::sendConfirmElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendConfirmElementRequestAction not implemented");
}

void LocalWaypointListDriver_ReceiveFSM::sendRejectElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendRejectElementRequestAction not implemented");
}
...
void LocalWaypointListDriver_ReceiveFSM::sendReportLocalWaypointExtAction(QueryLocalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportLocalWaypointExtAction not implemented");
}
...
void LocalWaypointListDriver_ReceiveFSM::sendReportTravelSpeedExtAction(QueryTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportTravelSpeedExtAction not implemented");
}

void LocalWaypointListDriver_ReceiveFSM::setElementAction(SetElement msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "setElementAction for ExecuteListExt not implemented");
}
...
bool LocalWaypointListDriver_ReceiveFSM::elementExists(ExecuteListExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "elementExists for ExecuteListExt not implemented");
    return false;
}
...
bool LocalWaypointListDriver_ReceiveFSM::elementSpecified(ExecuteListExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "elementSpecified for ExecuteListExt not implemented");
    return false;
}
...
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "isElementSupported for SetElement not implemented");
    return false;
}
bool LocalWaypointListDriver_ReceiveFSM::isValidElementRequest(SetElement msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "isValidElementRequest for SetElement not implemented");
    return false;
}
bool LocalWaypointListDriver_ReceiveFSM::waypointExists(QueryLocalWaypoint msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists for QueryLocalWaypoint not implemented");
    return false;
}
bool LocalWaypointListDriver_ReceiveFSM::waypointExists(QueryLocalWaypointExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists for QueryLocalWaypointExt not implemented");
    return false;
}
