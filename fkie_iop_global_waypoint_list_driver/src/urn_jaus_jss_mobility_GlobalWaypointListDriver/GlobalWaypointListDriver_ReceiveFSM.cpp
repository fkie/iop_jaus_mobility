...
void GlobalWaypointListDriver_ReceiveFSM::setupNotifications()
{
    ...
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready_NotControlled", ieHandler, "InternalStateChange_To_GlobalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    ...
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready_Controlled", ieHandler, "InternalStateChange_To_GlobalWaypointListDriver_ReceiveFSM_Receiving_Ready_Controlled_Available_Standby", "ListManager_ReceiveFSM");
    pListManager_ReceiveFSM->registerNotification("Receiving_Ready", ieHandler, "InternalStateChange_To_GlobalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    pListManager_ReceiveFSM->registerNotification("Receiving", ieHandler, "InternalStateChange_To_GlobalWaypointListDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "ListManager_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available_Standby", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Init", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Failure", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Shutdown", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Emergency", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointListDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Available_Standby", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available_Ready", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable_Emergency", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointListDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable", pListManager_ReceiveFSM->getHandler(), "InternalStateChange_To_ListManager_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointListDriver_ReceiveFSM");
...
void GlobalWaypointListDriver_ReceiveFSM::setupIopConfiguration()
{
    ...
    pListManager_ReceiveFSM->list_manager().register_supported_element(ReportGlobalWaypoint::ID, this);
...
void GlobalWaypointListDriver_ReceiveFSM::executeWaypointListAction(ExecuteListExt msg, Receive::Body::ReceiveRec transportData)
{
...
void GlobalWaypointListDriver_ReceiveFSM::modifyTravelSpeedAction(ExecuteListExt msg)
{
    /// Insert User Code HERE
...
void GlobalWaypointListDriver_ReceiveFSM::sendConfirmElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendConfirmElementRequestAction for SetElement not implemented");
}

void GlobalWaypointListDriver_ReceiveFSM::sendRejectElementRequestAction(SetElement msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendRejectElementRequestAction for SetElement not implemented");
}
...
void GlobalWaypointListDriver_ReceiveFSM::sendReportGlobalWaypointExtAction(QueryGlobalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportGlobalWaypointExtAction for QueryGlobalWaypointExt not implemented");
}
...
void GlobalWaypointListDriver_ReceiveFSM::sendReportTravelSpeedExtAction(QueryTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportTravelSpeedExtAction for QueryTravelSpeedExt not implemented");
}

void GlobalWaypointListDriver_ReceiveFSM::setElementAction()
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "setElementAction not implemented");
}
...
bool GlobalWaypointListDriver_ReceiveFSM::elementExists(ExecuteListExt msg)
{
    /// Insert User Code HERE
...
bool GlobalWaypointListDriver_ReceiveFSM::elementSpecified(ExecuteListExt msg)
{
    /// Insert User Code HERE
...
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists for QueryGlobalWaypoint not implemented");
    return false;
}

bool GlobalWaypointListDriver_ReceiveFSM::waypointExists(QueryGlobalWaypointExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists for QueryGlobalWaypointExt not implemented");
    return false;
}
...
geographic_msgs::msg::GeoPoseStamped GlobalWaypointListDriver_ReceiveFSM::get_geopose_from_waypoint(iop::InternalElement& element, bool update_current)
{
    ...
    ReportGlobalWaypoint::Body::GlobalWaypointRec* wprec = wp.getBody()->getGlobalWaypointRec();
