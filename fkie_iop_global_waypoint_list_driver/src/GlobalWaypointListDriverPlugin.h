...
#ifndef GLOBALWAYPOINTLISTDRIVERPLUGIN_H
#define GLOBALWAYPOINTLISTDRIVERPLUGIN_H

#include "urn_jaus_jss_mobility_GlobalWaypointListDriver/GlobalWaypointListDriverService.h"
...
class DllExport GlobalWaypointListDriverPlugin : public PluginInterface
{
public:
	GlobalWaypointListDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_mobility_GlobalWaypointListDriver::GlobalWaypointListDriverService *p_my_service;
