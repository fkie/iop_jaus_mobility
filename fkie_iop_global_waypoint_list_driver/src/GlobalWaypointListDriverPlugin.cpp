...
#include "GlobalWaypointListDriverPlugin.h"
...
GlobalWaypointListDriverPlugin::GlobalWaypointListDriverPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
	p_mgmt_service = NULL;
...
JTS::Service* GlobalWaypointListDriverPlugin::get_service()
{
	return p_my_service;
}

void GlobalWaypointListDriverPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new GlobalWaypointListDriverService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_mgmt_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::GlobalWaypointListDriverPlugin, iop::PluginInterface)
