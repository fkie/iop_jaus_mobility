...
public:
    ...
    virtual void modifyTravelSpeedAction(ExecuteListExt msg);
    ...
    virtual void sendReportGlobalWaypointExtAction(QueryGlobalWaypointExt msg, Receive::Body::ReceiveRec transportData);
    ...
    virtual bool waypointExists(QueryGlobalWaypointExt msg);
