...
public:
    ...
    virtual void sendReportGeomagneticPropertyAction(QueryGeomagneticProperty msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportGlobalPoseAction(QueryGlobalPose msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportGlobalPoseExtAction(QueryGlobalPoseExt msg, Receive::Body::ReceiveRec transportData);
    virtual void updateGeomagneticPropertyAction(SetGeomagneticProperty msg, Receive::Body::ReceiveRec transportData);
    virtual void updateGlobalPoseAction(SetGlobalPose msg, Receive::Body::ReceiveRec transportData);
    virtual void updateGlobalPoseExtAction(SetGlobalPoseExt msg, Receive::Body::ReceiveRec transportData);
