...
public:
    ...
    virtual void setTravelSpeedAction(SetTravelSpeed msg);
    virtual void setTravelSpeedExtAction(SetTravelSpeedExt msg);
    virtual void setWaypointAction(SetGlobalWaypoint msg);
    virtual void setWaypointExtAction(SetGlobalWaypointExt msg);
    ...
    virtual bool waypointExists(SetTravelSpeedExt msg);
