...
void GlobalWaypointDriver_ReceiveFSM::setupNotifications()
{
    ...
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_NotControlled", ieHandler, "InternalStateChange_To_GlobalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    ...
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_Controlled_Failure", ieHandler, "InternalStateChange_To_GlobalWaypointDriver_ReceiveFSM_Receiving_Ready_Controlled_Failure", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready_Controlled", ieHandler, "InternalStateChange_To_GlobalWaypointDriver_ReceiveFSM_Receiving_Ready_Controlled_Available_Standby", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving_Ready", ieHandler, "InternalStateChange_To_GlobalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    pManagement_ReceiveFSM->registerNotification("Receiving", ieHandler, "InternalStateChange_To_GlobalWaypointDriver_ReceiveFSM_Receiving_Ready_NotControlled_Available_Standby", "Management_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available_Standby", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_Available", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Init", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Failure", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Shutdown", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable_Emergency", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_NotControlled_NotAvailable", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_NotControlled", "GlobalWaypointDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Available_Standby", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available_Ready", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_Available", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable_Emergency", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointDriver_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled_NotAvailable", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled", "GlobalWaypointDriver_ReceiveFSM");
    ...
    registerNotification("Receiving_Ready_Controlled_Failure", pManagement_ReceiveFSM->getHandler(), "InternalStateChange_To_Management_ReceiveFSM_Receiving_Ready_Controlled_Failure", "GlobalWaypointDriver_ReceiveFSM");
...
void GlobalWaypointDriver_ReceiveFSM::sendReportGlobalWaypointExtAction(QueryGlobalWaypointExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportGlobalWaypointExtAction not implemented");
}
...
void GlobalWaypointDriver_ReceiveFSM::sendReportTravelSpeedExtAction(QueryTravelSpeedExt msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "sendReportTravelSpeedExtAction not implemented");
}

void GlobalWaypointDriver_ReceiveFSM::setTravelSpeedAction(SetTravelSpeed msg)
{
    p_travel_speed = msg.getBody()->getTravelSpeedRec()->getSpeed();
    RCLCPP_DEBUG(logger, "setTravelSpeedAction to %.2f", p_travel_speed);
...
void GlobalWaypointDriver_ReceiveFSM::setTravelSpeedExtAction(SetTravelSpeedExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "setTravelSpeedExtAction not implemented");
}

void GlobalWaypointDriver_ReceiveFSM::setWaypointAction(SetGlobalWaypoint msg)
{
    RCLCPP_DEBUG(logger, "setWaypointAction");
...
void GlobalWaypointDriver_ReceiveFSM::setWaypointExtAction(SetGlobalWaypointExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "setWaypointExtAction not implemented");
}
...
bool GlobalWaypointDriver_ReceiveFSM::waypointExists(QueryGlobalWaypointExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists with QueryGlobalWaypointExt not implemented");
    return false;
}
...
bool GlobalWaypointDriver_ReceiveFSM::waypointExists(SetTravelSpeedExt msg)
{
    /// Insert User Code HERE
    RCLCPP_WARN(logger, "waypointExists with SetTravelSpeedExt not implemented");
    return false;
}
