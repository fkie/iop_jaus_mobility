...
JTS::Service* LocalPoseSensorPlugin_1_0::get_iop_service()
{
	return p_my_service;
}

const std::type_info & LocalPoseSensorPlugin_1_0::get_iop_service_type()
{
	return typeid(LocalPoseSensorService);
}

const std::type_info & LocalPoseSensorPlugin_1_0::get_base_service_type()
{
	return typeid(AccessControlService);
}


void LocalPoseSensorPlugin_1_0::create_jts_service(JTS::JausRouter* jaus_router)
{
