...
LocalPoseSensorPlugin::LocalPoseSensorPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* LocalPoseSensorPlugin::get_service()
{
	return p_my_service;
}

void LocalPoseSensorPlugin::create_service(JTS::JausRouter* jaus_router)
{
...
PLUGINLIB_EXPORT_CLASS(iop::LocalPoseSensorPlugin, iop::PluginInterface)
